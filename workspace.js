...
cprequire_test(["inline:com-alexphredorg-workspace-dripfeed"], function(ws) {
    ...
    $('title').html("Drip Feed Workspace");
...
cpdefine("inline:com-alexphredorg-workspace-dripfeed", ["chilipeppr_ready"], function() {
    return {
         ...
         */
        id: "com-alexphredorg-workspace-dripfeed", // Make the id the same as the cpdefine id
        name: "Workspace / Sample", // The descriptive name of your widget.
        desc: `A ChiliPeppr Dripfeeding Workspace.`,
